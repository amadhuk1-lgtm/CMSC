...
** This file contains irrigator and region class header file.                                       
*****************************************/
#ifndef IRRIGATOR_H
#define IRRIGATOR_H
#include <stdexcept>
...
class Region{
    ...
    void deleteTree(Crop* root);
    int recomputeNPL(Crop* root);
    Crop* copyTree(const Crop* root) const;
    Crop* merge(Crop* h1, Crop* h2);
    void detachAllNodes(Crop* root, Crop*& head, Crop*& tail);
    void preorderTraversal(Crop* root) const;
