...
** This file contains the header file                                                                      
*****************************************/
#ifndef CACHE_H
#define CACHE_H
#include <iostream>
...
class Cache{
    ...
    ******************************************/
    int queryIndex(const Person& person, bool old = false, bool collideDel = true) const;
    Person* queryPerson(const Person& person) const;
    Person* queryPerson(const Person& person, bool& old) const;
    int getProbeIndex(const Person& person, int i, bool old) const;
    void startRehashIfNeeded();
    bool continueRehashOneBatch();
    void transfer();
